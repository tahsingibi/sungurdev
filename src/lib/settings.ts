...
const settings: Settings = {
  ...
  nav: [
    { id: 0, name: "home", path: "/", icon: "home-line" },
    { id: 1, name: "experience", path: "/works", icon: "code-s-slash-line" },
    { id: 2, name: "write", path: "/write", icon: "edit-line" },
  ],
  social: [
    {
      id: 0,
  ...
  experience: [
    {
      ...
      path: "/works#Hypeople",
      description:
        "<p>At Hypeople Studio, I develop end-to-end web applications tailored to the needs of both individual and corporate clients. Throughout this process, I specialize in delivering customer-focused projects with a strong emphasis on user experience, performance optimization, security, and scalability. Additionally, I integrate modern web technologies and advanced animations into these projects, providing innovative and impactful solutions.</p>",
      projects: [
        {
          id: "HY001",
  ...
  blog: {
    contentDirectory: "content/blogs",
    repository: "https://github.com/tahsingibi/sungurdev",
